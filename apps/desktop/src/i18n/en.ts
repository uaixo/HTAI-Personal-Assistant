...
export const en: Translations = {
  ...
  boot: {
    ...
    errors: {
      ...
      ipcBridgeUnavailable: "NousAI Desktop couldn't talk to its own background layer. Restart the app."
    },
  ...
  settings: {
    ...
    gateway: {
      ...
      unavailableDesc: 'Connection settings can only be changed from the NousAI Desktop app on the computer running it.',
