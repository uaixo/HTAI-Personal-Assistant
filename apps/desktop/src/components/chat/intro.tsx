...
const FALLBACK_COPY: IntroCopy[] = [
  ...
  {
    headline: 'What should NousAI look at?',
...
function fallbackCopyForPersonality(personalityKey: string): IntroCopy[] {
  ...
  return [
    ...
    {
      headline: `What does ${label} NousAI need to see?`,
    ...
    {
      headline: `What should ${label} NousAI tackle?`,
...
const WORDMARK = 'NOUS AI ASSISTANT'
