...
const en: BotsMessages = {
  editor: {
    ...
    newerDesktop: 'Skills need a newer NousAI Desktop.',
  ...
  bot: {
    ...
    openAnotherChatUnsupported: 'Update NousAI Desktop to open another Bot chat.',
    remoteConnectionsUnsupported: 'Update NousAI Desktop to chat with bots on other connections.',
...
const ja: BotsMessages = {
  editor: {
    ...
    newerDesktop: 'スキルには新しい NousAI Desktop が必要です。',
  ...
  bot: {
    ...
    openAnotherChatUnsupported: '別のボットチャットを開くには NousAI Desktop を更新してください。',
    remoteConnectionsUnsupported: '他の接続上のボットとチャットするには NousAI Desktop を更新してください。',
...
const zh: BotsMessages = {
  editor: {
    ...
    newerDesktop: '技能功能需要更新的 NousAI Desktop。',
  ...
  bot: {
    ...
    openAnotherChatUnsupported: '请更新 NousAI Desktop 以打开另一个机器人聊天。',
    remoteConnectionsUnsupported: '请更新 NousAI Desktop 以与其他连接上的机器人聊天。',
...
const zhHant: BotsMessages = {
  ...
  bot: {
    ...
    openAnotherChatUnsupported: '請更新 NousAI Desktop 以開啟另一個機器人聊天。',
    remoteConnectionsUnsupported: '請更新 NousAI Desktop 以與其他連線上的機器人聊天。',
